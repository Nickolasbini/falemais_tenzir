...
<section class="mt-5 mb-5 container text-center-sm">
    ...
    <h2 class="mt-3 primary-color text-center">Termos e condições de uso do site ou blog</h2>
    ...
    <h4 class="mt-5 primary-color text-center">2. DO ACEITE DOS TERMOS</h4>
    ...
    <h4 class="mt-5 primary-color text-center">3. DO GLOSSÁRIO</h4>
    ...
    <h4 class="mt-5 primary-color text-center">4. DO ACESSO AO SITE</h4>
    ...
    <h4 class="mt-5 primary-color text-center">5. DA LICENÇA DE USO E CÓPIA</h4>
    ...
    <h4 class="mt-5 primary-color text-center">6. DAS OBRIGAÇÕES</h4>
    ...
    <h4 class="mt-5 primary-color text-center">7. DA MONETIZAÇÃO E PUBLICIDADE</h4>
    ...
    <h4 class="mt-5 primary-color text-center">8. DOS TERMOS GERAIS</h4>
    ...
    Este Termo de uso é valido a partir de 01 de Janeiro de 2022.
</section>
